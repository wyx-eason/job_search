...
const BASE_TEMPLATE_FILES = {
  ai: path.resolve("E:/job_search/profile/王奕迅_AI应用_基类_2026.html"),
  adas: path.resolve("E:/job_search/profile/王奕迅_ADAS_基类_2026.html"),
  softdev: path.resolve("E:/job_search/profile/王奕迅_软开C++_基类_2026.html"),
...
export function buildResumeFromBaseTemplate({ candidate, sections, keywords, job, base = "ai", photoSrc = null }) {
  ...
  if (photoSrc) {
    tpl = tpl.replace(/<img src="[^"]*"/, `<img src="${esc(photoSrc)}"`);
  } else {
    tpl = tpl.replace(/<div class="photo"[\s\S]*?<\/div>/, "");
  }
  return tpl;
}
