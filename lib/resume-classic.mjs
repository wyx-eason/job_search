...
<style>
  ...
  body { font-family: "Times New Roman", SimSun, "Songti SC", serif; font-size: 9.5pt; line-height: 1.24; color: #111; margin: 0; }
  h1 { font-size: 16pt; text-align: center; margin: 0 0 2px; letter-spacing: 1px; }
  .contact { text-align: center; color: #444; font-size: 9.5pt; margin: 0 0 7px; }
  h2 { font-size: 11pt; margin: 6px 0 2px; padding-bottom: 1px; border-bottom: 1px solid #999; letter-spacing: .5px; }
  .dated-row { display: flex; justify-content: space-between; align-items: baseline; margin-top: 3px; }
  ...
  ul.entry { margin: 1px 0 0; padding-left: 17px; }
