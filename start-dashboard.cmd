...
rem dashboard opens in Edge by default; falls back to Chrome, then system default
...
powershell -NoProfile -Command "Get-CimInstance Win32_Process -Filter \"Name='chrome.exe' or Name='msedge.exe'\" | Where-Object { $_.CommandLine -like '*chrome-profile*' -or $_.CommandLine -like '*edge-profile*' } | ForEach-Object { Stop-Process -Id $_.ProcessId -Force -ErrorAction SilentlyContinue }" >nul 2>&1
...
if exist "!EDGE!" (
  start "" "!EDGE!" http://127.0.0.1:8787
